...
class WishlistRepository {
  ...
  CollectionReference<Map<String, dynamic>> _wishlistItemsCollection(
    String userId,
    String wishlistId,
  ) {
    return _wishlistCollection(
      userId,
    ).doc(wishlistId).collection('wishlistItems');
  }
  ...
  Future<void> addWishlistItem(
    ...
    await _wishlistItemsCollection(
      userId,
      wishlistId,
    ).doc(item.wishlistItemId).set(item.toMap());
  }
